...
create table `BOOKING`(
	...
	`Table_Num` varchar(9) NOT NULL,
	`Date_Time` varchar(30) NOT NULL,
	`Cust_Id` varchar(9) NOT NULL,
	PRIMARY KEY (`Booking_Id`),
	FOREIGN KEY (`Cust_Id`) REFERENCES `CUSTOMER`(`Customer_Id`),
	FOREIGN KEY (`Table_Num`) REFERENCES `TABLE`(`Table_Number`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
create table `INGREDIENT`(
	...
	`Supplier_Fname` varchar(15) NOT NULL,
	`Supplier_Lname` varchar(15) NOT NULL,
	PRIMARY KEY (`Ingredient_Id`,`Name`),
	FOREIGN KEY (`Supplier_Fname`,`Supplier_Lname`) REFERENCES `SUPPLIER`(`Fname`,`Lname`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
